...
//        System.out.println(users);
        ...
        InputHandler<Bus> busHandler = new BusManualInputHandler();
        CustomArrayList<Bus> buses = ManualInputService.inputMultiple(busHandler);

        System.out.println("Введённые автобусы:");
        System.out.println(buses);
    }
}
